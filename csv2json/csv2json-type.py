...
for i in AS_IP:
        json.write("{\"color\":\""+color[number]+"\""+",\"label\":\""+str(check_error(AS_Name,i))+"\""+",\"attributes\":{},\"y\":"+str(rangeY)+",\"x\":"+str(rangeX)+",\"id\":"+"\""+str(i)+"\""+",\"size\":"+str(AS_IP[i]/36)+",\"category\":"+"\""+str(check_error(AS_Cat,i))+"\""+"}")
